...
// Generate PDF (CORREGIDA - Versión visible para html2canvas)
function generatePDF() {
    ...
    // Crear contenedor VISIBLE temporal (cubriendo la pantalla)
    ...
    // Añadir al body (visible)
    document.body.appendChild(element);
    
    // Dibujar el gráfico en el canvas visible
    ...
    // Pequeña pausa para asegurar que el gráfico esté renderizado
    setTimeout(() => {
        html2pdf()
            .set(opt)
            .from(element)
